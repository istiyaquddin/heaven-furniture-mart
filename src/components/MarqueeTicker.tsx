...
export default function MarqueeTicker() {
  const content = (
    <div className="flex items-center gap-8 sm:gap-12 px-6 sm:px-8 shrink-0">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 text-ivory-muted hover:text-gold transition-colors"
      >
        <Phone className="w-3 h-3 text-gold inline-block" />
        <span>
          STUDIO CONCIERGE:{" "}
          <strong className="text-ivory font-semibold">+880 1960-481983</strong>
        </span>
      </a>
      ...
      <span className="text-ivory-muted">
        FOUNDED 2020 BY{" "}
        <span className="text-ivory font-semibold">MD ABUL KALAM BHUIYAN</span>{" "}
        · CHATTOGRAM
      </span>
  ...
  return (
    <div
      className="ticker-container relative overflow-hidden bg-[#0A1616] text-ivory border-y border-gold/30 h-12 sm:h-14 -my-6 sm:-my-8 flex items-center text-[10px] sm:text-[11.5px] tracking-[0.16em] uppercase font-medium select-none shadow-lg z-20"
      role="region"
